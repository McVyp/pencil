export const UnlikeAnyTool =() =>(
    <div className="text-white">
        ...
        <div className="flex flex-wrap gap-6">
            <div className="bg-glass-gradient p-8 md:p-14 border border-transparent-white rounded-[4.8rem] basis-[calc(66.66%-12px)] text-center">
            ...
            <div className="bg-glass-gradient p-8 md:p-14 border border-transparent-white rounded-[4.8rem] basis-[calc(33.33%-12px)] text-center">
