  ...
  return (
    <header className='fixed top-0 left-0 w-full border-b border-white-a08 backdrop-blur-[12px]'>
        <Container className='flex h-navigation-height'>
            ...
            <nav className={classNames('h-[calc(100vh_-_var(--navigation-height))] md:block fixed md:relative top-navigation-height left-0 bg-background w-full overflow-auto md:h-auto md:w-auto md:top-0 md:bg-transparent ', hamburgerMenuIsOpen? '' : 'hidden')}>
